...
SAFE_CAST(prazo_confidencialidae_aplicacao AS STRING) prazo_confidencialidade_aplicacao,
...
SUBSTR(REGEXP_REPLACE(cnpj_fundo_investido, r'[^0-9]', ''), 1, 8) AS cnpj_basico_fundo_investido,
