{{
    config(
        alias="taxa_evolucao_mensal_uf", schema="br_rj_isp_estatisticas_seguranca"
    )
}}
...
from
    `basedosdados-staging.br_rj_isp_estatisticas_seguranca_staging.taxa_evolucao_mensal_uf` t
