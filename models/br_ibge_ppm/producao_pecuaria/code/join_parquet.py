...
for temp_ano in ANOS:
    df_ovinos = pd.read_parquet(f"../source/ovinos_tosquiados/parquet/ano={temp_ano}/data.parquet")
    df_vacas = pd.read_parquet(f"../source/vacas_ordenhadas/parquet/ano={temp_ano}/data.parquet")

    print(f"Criando o DataFrame com os dados consolidados, referente ao ano de {temp_ano}...")
