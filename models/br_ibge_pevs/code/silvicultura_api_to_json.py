...
CATEGORIAS =    pd.read_csv('silvicultura_metadados_enriquecidos.csv', dtype=str)['id'].tolist()
BAIXADOS =      [int(x.stem) for x in Path('./output/silvicultura/json/').glob('*.json')]
